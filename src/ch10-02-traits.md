...
Чтобы использовать такое исполнение сущности `КраткоеСодержание`, нужно только определить способ `подвести_итог_сочинителя`, когда мы используем сущность для вида данных:
