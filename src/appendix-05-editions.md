...
Язык Ржавчина и его сборщик имеют шестинедельный круговорот выпуска, означающий, что пользователи постоянно получают новые способы (функции). В других языках обычно выпускают большие обновления, но редко. Объединение Ржавчина выпускает меньшие обновления, но более часто. Через некоторое время все эти небольшие изменения накапливаются. Между исполнениями обычно сложно оглянуться назад и сказать "Ого, язык сильно изменился между исполнениями Ржавчина 1.10 и Ржавчина 1.31!"

Каждые два или три года, объединение Ржавчина выпускает новую издание языка *(Ржавчина edition)*. Каждая издание объединяет все новые особенности, которые попали в язык с новыми дополнениями, с полной, обновлённой пособием и набором средств. Новые издания поставляются как часть шестинедельного шага исполнений.
...
На мгновение написания доступны два издания: Ржавчина 2021 и Ржавчина 2024. Данная книга написана с использованием устойчивых выражений издания Ржавчины 2024.

Ключ `edition` в настроечном файле  *Cargo.toml* отображает, какое издание сборщик должен использовать для вашей рукописи. Если ключа нет, то для обратной совместимости сборщик Ржавчины использует издание `2021`.

Любое дополнение может выбрать издание, отличное от издания по умолчанию, которое значится 2021. Издания могут содержать несовместимые изменения, включая новые ключевые слова, которые могут враждовать с определителями в рукописи. Однако, пока вы не переключитесь на новую издание, ваша рукопись будет продолжать собираться даже после обновления используемой исполнения сборщика.

Все исполнения сборщика Ржавчины поддерживают любое издание, которое предшествовало выпуску текущего, и они могут ссылаться на любое дополнение поддерживаемого издания. Изменения изданий действуют только на способ начального разбора сборщиком исходной рукописи. Поэтому, если вы используете издание 2021, а одно из ваших дополнений использует издание 2024, ваш ящик будет собрано и сможет пользоваться этим дополнением. Обратный случай, когда ваш ящик использует издание Ржавчины 2024, а дополнение использует издание Ржавчины 2021, работает таким же образом.
