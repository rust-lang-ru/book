...
- [Общие подходы программирования](ch03-00-common-programming-concepts.md)
    ...
    - [Способы (функции)](ch03-03-how-functions-work.md)
...
- [Полезные  возможности языка: повторители и замыкания](ch13-00-functional-features.md)
    ...
    - [Замыкания: безымянные способы (функции), которые получают своё окружение](ch13-01-closures.md)
...
- [Расширенные возможности](ch20-00-advanced-features.md)
    ...
    - [Продвинутые способы (функции) и замыкания](ch20-04-advanced-functions-and-closures.md)
    - [Макросы](ch20-05-macros.md)

- [Конечный шаг: создание многопоточного сетевого отдельного вычислителя](ch21-00-final-project-a-web-server.md)
