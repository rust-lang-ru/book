...
<span class="caption">рукопись 20-13: вызов способа (функции) `ThreadPool::new`, который прервёт
...
мы не задумывались о виде входных данных. Задумаемся сейчас. Вид данных `usize` имеет большое значение для вектора. Давайте изменим описание способа (функции):
