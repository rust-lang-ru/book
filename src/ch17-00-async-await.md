...
длительных шагов. Современные компьютеры предлагают два способа для
...
<figcaption>Рисунок 17-1: Одновременный рабочий шаг, переключение между задачей A и задачей B</figcaption>
...
<figcaption>Рисунок 17-2: Одновременный рабочий шаг, в котором работа над задачей A и задачей B выполняется независимо</figcaption>

</figure>

В обоих этих рабочих шагах вам, возможно, придется координировать различные
...
<figcaption>Рисунок 17-3: Частично одновременный рабочий шаг, в котором работа над задачей A и задачей B выполняется независимо, пока задача A3 не будет заблокирована по итогам задачи B3.</figcaption>
...
все еще может работать одновременно. Используя такие средства, как потоки, шаги и несогласованность,
