...
Мы начнём создавать наш пример использования звена. Создадим дело библиотеки рукописей.
...
Мы изучим использование связанных стопок `#[]` и `mod tests` в последующих разделах "Использование `super` для доступа к родительскому звену" этой главы.
...
Первым делом напишем определение звена `network`, которое будет содержать
...
для какой-либо двоичной программы. Очень важная особенность звеньев - они могут быть вложенными. 
...
Состоящее из звеньев устройство похоже на файловую систему. Мы можем использовать состоящую из звеньев
