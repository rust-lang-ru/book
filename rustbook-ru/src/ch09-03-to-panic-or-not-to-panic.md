...
- There’s not a good way to encode this information in the types you use. We’ll work through an example of what we mean in the [“Encoding States and Behavior as Types”](ch17-03-oo-design-patterns.html#encoding-states-and-behavior-as-types)<!-- ignore --> section of Chapter 17.
