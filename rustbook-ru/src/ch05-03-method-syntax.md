...
Ключевые слова `Self` в возвращаемом виде данных и в теле способы (функции) являются псевдонимами для вида данных, указанного после ключевого слова `impl`, которым в данном случае является `Прямоугольник`.
