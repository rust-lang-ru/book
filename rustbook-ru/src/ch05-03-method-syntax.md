...
>
<<<<<<< HEAD
> Ржавчина не имеет эквивалента приказчика `->`, наоборот, в Ржавчине есть возможность называемая *самостоятельное обращение по ссылке и разыменование* (automatic referencing and dereferencing). Вызов способов является одним из немногих мест в Ржавчине, в котором есть такое поведение.
=======
...
<<<<<<< HEAD
Каждая устройства может иметь несколько `impl`. Например, Приложение 5-15 эквивалентен рукописи, показанному в приложении 5-16, в котором каждый способ находится в своём собственном разделе `impl`.
=======
...
=======
Устройства позволяют создавать собственные виды, которые имеют смысл в вашей предметной области. Используя устройства, вы храните сопряженные друг с другом отрывки данных и даёте название частям данных, чтобы вашу рукопись был более понятным. Способы позволяют определить поведение, которое имеют образцы ваших устройств, а сопряженные функции позволяют привязать возможность к вашей устройстве, не обращаясь к её образцу.
>>>>>>> 8026f7cc37a623b7a0968ae296cbb5f4118ea196
