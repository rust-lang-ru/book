...
<span class="caption">Приложение 5-15: Выполнение способа <code>can_hold</code> для <code>Rectangle</code>, принимающего другой образец <code>Rectangle</code> в качестве свойства</span>
