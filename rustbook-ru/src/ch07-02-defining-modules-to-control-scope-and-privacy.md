...
В листинге 7-2 показано дерево модулей для структуры модулей приведенной в коде листинга 7-1.
...
<span class="caption">Листинг 7-2: Дерево модулей для для структуры модулей приведенной в коде в листинге 7-1</span>
