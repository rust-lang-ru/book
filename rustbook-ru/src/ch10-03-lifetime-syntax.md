...
Если мы попробуем реализовать функцию `longest` так, как это показано в листинге 10-21, то программа не будет скомпилирована:
