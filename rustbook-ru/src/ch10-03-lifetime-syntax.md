...
Аннотирование времени жизни — это не концепция присутствуюшая в большинстве других языков программирования, так что она может показаться незнакомой. Хотя в этой главе мы не будем полностью рассматривать время жизни, мы обсудим распространенные способы, с помощью которых вы можете столкнуться с синтаксисом времени жизни, чтобы вы могли познакомиться с этой концепцией.
