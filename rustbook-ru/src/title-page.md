...
Эта версия книги предполагает, что вы используете Rust версии 1.37.0 и больше, а во всех проектах в *Cargo.toml* установлено `edition="2018"` для использования идиом 2018 редакции Rust. Для установки или обновления Rust смотрите раздел ["Установка" главы 1](ch01-01-installation.html)<comment>. Больше информации о редакциях можно найти в <a href="appendix-05-editions.html">приложении Д</a></comment><comment>.</comment>
