...
Попробуем запустить этот код. Замените программу из проекта  <br>*functions* в файле *src/main.rs* следующим примером и запустите его командой `cargo run{code2}:`
