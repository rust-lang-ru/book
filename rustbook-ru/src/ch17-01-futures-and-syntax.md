...
цепочки способов намного более удобными для работы. В итоге мы можем изменить тело `page_title`, чтобы связать вызовы способов (функций) `trpl::get` и `text` вместе,
