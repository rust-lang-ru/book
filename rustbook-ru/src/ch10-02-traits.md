...
<span class="caption">Приложение 10-13: Выполнение сущности <code>Summary</code> для устройств <code>NewsArticle</code> и <code>Tweet</code></span>
