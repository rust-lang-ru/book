...
Данная рукопись выведет: `1 new socialpost: horse_ebooks: конечно, как вы, вероятно, уже знаете, люди`.
...
Эта рукопись выводит `New article available! (Прочесть больше...)` .
...
Эта рукопись выводит `1 new socialpost: (Прочесть больше from @horse_ebooks...)` .
