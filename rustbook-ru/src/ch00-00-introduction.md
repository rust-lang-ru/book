...
> Note: This edition of the book is the same as [The Rust Programming Language](https://nostarch.com/rust) available in print and ebook format from [No Starch Press](https://nostarch.com/).
...
The source files from which this book is generated can be found on [GitHub](https://github.com/rust-lang/book/tree/master/src).