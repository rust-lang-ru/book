...
<span class="caption">Listing 5-10: Defining a <code>Rectangle</code> struct</span>
...
<span class="caption">Listing 5-11: Attempting to print a <code>Rectangle</code> instance</span>
...
<span class="caption">Listing 5-12: Adding the annotation to derive the <code>Debug</code> trait and printing the <code>Rectangle</code> instance using debug formatting</span>
