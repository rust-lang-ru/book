...
Используя правила написания обновления устройства, можно получить тот же итог, используя меньше кода как показано в приложении 5-7. правила написания `..` указывает, что оставшиеся поля устанавливаются неявно и должны иметь значения из указанного образца.
...
[«Из обоймы данные: повторение»]: ch04-01-what-is-ownership.html#stack-only-data-copy