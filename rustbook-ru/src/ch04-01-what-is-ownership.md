...
>
> Когда ваша рукопись вызывает функцию, то все значения, переданные в неё (возможно включающие указатели на данные в куче), и свои переменные помещаются в обойму. Когда функция завершается, эти значения извлекаются из обоймы.
>
