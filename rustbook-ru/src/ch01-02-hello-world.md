...
Тело способы (функции) заключено в `{}`. Ржавчина требует узорчатых скобок вокруг всех тел способов (функций). Принятое внешнее исполнение — поместить открывающую узорчатую скобку на ту же строку, что и объявление способы (функции), добавив между ними один пробел.
