...
Ржавчина может сообщить, что `'c'` находится в ряде первого образца и вывести `early ASCII letter`.
