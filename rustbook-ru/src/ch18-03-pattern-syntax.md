...
До сих пор все наши примеры сопоставляли стопки или перечисления на один уровень глубины, но сопоставление может работать и с вложенными элементами! Например, мы можем повторно согласовать рукопись в приложении 18-15 для поддержки цветов RGB и HSV в сообщении `ChangeColor` , как показано в приложении 18-16.
