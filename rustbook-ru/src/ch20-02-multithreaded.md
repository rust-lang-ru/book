...
2. Каждый `Worker` будет привязан к приемнику.
...
<span class="caption">Листинг 20-18. Совместное использование приемника в "работниках" с применением <code>Arc</code> и <code>Mutex</code></span>
