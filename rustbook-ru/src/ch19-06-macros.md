...
Теперь, когда у нас есть рукопись для преобразования определеного Ржавчиной рукописи из `TokenStream` в образец данных `DeriveInput`, давайте создадим рукопись выполняющаясущность `HelloMacro` у определеного вида данных, как показано в приложении 19-33.
