...
Также, как вы используете рукопись приложения в функциях, вы можете использовать функции в разделах. Раздел представляет собой пространство имён, в которое могут входить различные функции и виды данных. Вы также можете управлять видимостью внутри раздела.
