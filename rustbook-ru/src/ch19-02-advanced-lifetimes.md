...
необходимо создать устройство, образцы которого будут хранить ссылки на строку, которую
мы рассмотриваем. Назовём это устройство `Context`. Мы создадим оценщик, который
...
Эта рукопись собирается. Следующая рукопись (19-14) декларирует функцию, которая получает
