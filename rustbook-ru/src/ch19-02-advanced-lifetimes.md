...
мы можем объявить продолжительность жизни `'a` как обычно, и объявить параметр времени жизни
...
различия между типом, который не содержит ссылок и типами, ссылки на которые живут вечно.
