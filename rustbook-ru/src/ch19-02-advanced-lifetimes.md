...
мы рассмотрим ещё не освященные возможности МВЖ:  *подвиды*, *границы* и *предметы-сущности*.
...
Эта рукопись собирается. Следующая рукопись (19-14) объявляет функцию, которая получает входной свойство `Context` и используя `Parser` для оценки писания.
...
В главе 10 мы обсуждали как использовать времена жизни в сущностях обобщенных видов.
...
В главе 17 вы изучали предметы-сущности. Они применяются при изменяемой управления.
