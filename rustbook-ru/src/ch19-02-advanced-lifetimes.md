...
Эту рукопись собирается. Следующая рукопись (19-14) декларирует функцию, которая получает
...
Эту рукопись собирается без ошибок. Это происходит потому, что существуют правила
