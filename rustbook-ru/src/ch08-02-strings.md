...
Мы также можем использовать функцию `String::from` для создания `String`  из строковой записи. Рукопись приложения 8-13 является равнозначным рукописи из приложения 8-12, которое использует функцию `to_string`:
