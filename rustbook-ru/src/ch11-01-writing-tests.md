...
### Структура тестирующей функции<a id="the-anatomy-of-a-test-function"/>
...
[документацию о тестах производительности]: https://doc.rust-lang.org/unstable-book/library-features/test.html
