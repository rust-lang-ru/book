...
что при попытке создать некоторый рукопись, напив сначала конечного потребителя внешнюю оболочка можно
...
рукопись в замыкании. Если вы запустите этот рукопись и загрузите `/sleep` и затем `/` в
...
Давайте попробуем собрать данный рукопись. Мы получим следующие ошибки:
...
Далее, попытайтесь теперь проверить соблюдение правил нашего рукописи, получил следующие
