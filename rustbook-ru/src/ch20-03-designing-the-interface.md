...
Использование `ThreadPool` будет независимой от работы сетевого-отдельного вычислителя. После того, как
...
Му установили `u32` в качестве вида данных входящего свойства переменной `size`, т.к.
