...
<span class="caption">Приложение 14-6: Программа, использующая реэкспортированные переменные из дополнения <code>art</code></span>
