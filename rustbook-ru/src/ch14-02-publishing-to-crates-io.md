...
Примечания к пособию внутри элементов полезны для описания ящиков и разделов особенно. Используйте их, чтобы объяснить общую цель дополнения, чтобы помочь вашим пользователям понять устройство ящика.
