...
использовано другой библиотекой, вам нужно найти другое имя и отредактировать
...
библиотек из [crates.io](https://crates.io/)<!-- ignore -->, продолжали работать.
...
проектам начать зависеть от версии снова:
