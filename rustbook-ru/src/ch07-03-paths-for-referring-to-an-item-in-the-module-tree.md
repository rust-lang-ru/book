...
>
> В [Главе 12]<!-- ignore --> мы использовали данный опыт согласования рукописи с помощью приложения с окном вывода, которое будет содержать как двоичный, так и библиотечный дополнения.
