...
Чтобы показать Ржавчине, где найти элемент в дереве разделов, мы используем путь так же, как мы используем путь при поиске по файловой системе. Чтобы вызвать функцию, нам нужно знать её путь.
