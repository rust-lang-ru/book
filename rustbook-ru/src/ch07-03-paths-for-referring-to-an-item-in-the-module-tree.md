...
>
> В Главе 12<!-- ignore --> мы продемонстрируем эту организационную практику с помощью программы командной строки, которая будет содержать как бинарный, так и библиотечный крейты.
