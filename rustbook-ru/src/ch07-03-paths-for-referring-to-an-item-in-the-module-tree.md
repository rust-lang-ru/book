...
`pub`. Note that this example won’t compile just yet; we’ll explain why in a bit.
...
<span class="caption">Listing 7-3: Calling the <code>add_to_waitlist</code> function using absolute and relative paths</span>
...
<span class="caption">Listing 7-5: Declaring the <code>hosting</code> module as <code>pub</code> to use it from <code>eat_at_restaurant</code></span>
...
<span class="caption">Listing 7-7: Adding the <code>pub</code> keyword to <code>mod hosting</code> and <code>fn add_to_waitlist</code> lets us call the function from <code>eat_at_restaurant</code></span>
...
<span class="caption">Listing 7-8: Calling a function using a relative path starting with <code>super</code></span>
