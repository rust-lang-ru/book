...
Подробнее о образцах и совпадениях мы поговорим в [Главе 18]<!-- ignore -->. Пока же мы перейдём к правилам написания `if let`, который может быть полезен в случаейх, когда выражение `match` слишком многословно.
