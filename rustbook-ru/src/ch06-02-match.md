...
Давайте представим, что наш друг пытается собрать все 50 четвертных для всех штатов. В то время как мы сортируем мелочь по типу монеты, мы также будем печатать имя штата, связанное с каждой четвертной. Таким образом, если ее нет у нашего друга, то ее можно добавить его в его коллекцию.
