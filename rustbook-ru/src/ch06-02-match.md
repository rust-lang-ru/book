...
Есть ещё одна особенность `match`, которую мы должны обсудить: образцы должны покрывать все возможные исходы. Рассмотрим это исполнение нашей функции `увеличить_на_единицу`, которое содержит ошибку и не собирается:
