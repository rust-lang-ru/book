...
Создать пустую хеш-карту можно с помощью `new`, а добавить в неё переменные - с помощью `insert`. В приложении 8-20 мы отслеживаем счёт двух приказов, синей *Blue* и жёлтой *Yellow*. Синяя приказ набрала 10 очков, а жёлтая приказ - 50.
