...
Подобно векторам, хеш-карты хранят свои данные в куче. Здесь вид `HashMap` имеет в качестве вида ключей `String`, а в качестве вида данных значений вид `i32`. Как и векторы, HashMap однородны: все ключи должны иметь одинаковый вид и все значения должны иметь тоже одинаковый вид.
