...
Это дополнение содержит глоссарий правил написания Rust, включая операторы и другие обозначения, которые появляются сами по себе или в среде путей, обобщений, типажей, макросов, свойств, примечаниев, кортежей и скобок.
