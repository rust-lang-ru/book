...
Это дополнение содержит свод правил написания Ржавчины, включая приказчики и другие обозначения, которые появляются сами по себе или в среде путей, обобщений, сущностей, макросов, свойств, примечаний, составных рядов и скобок.
...
`fn ident<...> ...` | Определение обобщённой способы (функции)
...
Таблица Б-8 показывает обозначения, которые появляются в среде использования составных рядов.
...
`(type, ...)` | Выражение вызова способы (функции); также используется для объявления стопок-составных рядов и исходов-составных рядов перечисления
