...
Это дополнение содержит свод правил написания Ржавчины, включая приказчики и другие обозначения, которые появляются сами по себе или в среде путей, обобщений, особенностей, макросов, свойств, примечаний, упорядоченных рядов и скобок.
...
Обозначение | Объяснение
--- | ---
`T: U` | Обобщённое свойство `T` ограничивается до видов которые выполняют сущность `U`
