...
<span class="caption">Листинг 16-12: Изучение API <code>Mutex</code> для простоты в однопоточном контексте.</span>
...
<span class="caption">Листинг 16-13. Десять потоков каждый из которых увеличивает счётчик, защищённый <code>Mutex</code></span>
