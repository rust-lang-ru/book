...
Например, рукопись программы 9-6 читает имя пользователя из файла. Если файл не существует или не может быть прочтён, то функция возвращает ошибку в рукопись, которая вызвала данную функцию.
