...
Для ресурсов на языках, отличных от английского. Большинство из них все еще в разработке; см. [ярлык «Переводы»,](https://github.com/rust-lang/book/issues?q=is%3Aopen+is%3Aissue+label%3ATranslations) чтобы помочь или сообщить нам о новом переводе!
