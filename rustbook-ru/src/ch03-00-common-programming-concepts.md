...
В частности вы изучите переменные, основные виды, функции, примечания и поток управления. Эти основополагающие понятия будут присутствовать в каждой программе на Ржавчине, и их изучение на раннем этапе даст вам прочную основу для начала работы.
