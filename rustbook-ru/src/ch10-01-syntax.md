...
<span class="caption">Listing 10-6: Использование структуры <code>Point</code> содержащей поля
<code>x</code> и <code>y</code> типа <code>T</code></span>
...
<span class="caption">Listing 10-8: A <code>Point<T, U></code> generic over two types so
that <code>x</code> and <code>y</code> can be values of different types</span>
