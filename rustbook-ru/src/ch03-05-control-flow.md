...
Также стоит отметить, что условие в этой рукописи *должно* быть разумного вида `bool`. Если условие не является `bool`, возникнет ошибка. Например, попробуйте запустить следующий рукопись:
