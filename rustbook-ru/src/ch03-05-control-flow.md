...
Для перебора элементов собрании, например, массива, можно использовать круговорот `while`. Например, круговорот в приложении 3-4 выводит каждый элемент массива `a`.
