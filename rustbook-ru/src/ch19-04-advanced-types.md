...
> Note: The next section assumes you’ve read the earlier section [“Using the Newtype Pattern to Implement External Traits on External Types.”](ch19-03-advanced-traits.html#using-the-newtype-pattern-to-implement-external-traits-on-external-types)<!-- ignore -->
...
<span class="caption">Listing 19-26: A <code>match</code> with an arm that ends in <code>continue</code></span>

At the time, we skipped over some details in this code. In Chapter 6 in [“The `match` Control Flow Operator”](ch06-02-match.html#the-match-control-flow-operator)<!-- ignore
