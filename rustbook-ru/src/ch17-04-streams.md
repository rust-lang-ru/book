...
Теперь, вернувшись в несогласованный раздел нашей основной функции, мы можем попытаться объединить потоки `messages` и `intervals`, как показано в приложении 17-37.
