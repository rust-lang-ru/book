...
[*enumerations*]: ch06-00-enums.html
[`expect` method]: ../std/result/enum.Result.html#method.expect
[семантическое версионирование]: http://semver.org
[Crates.io]: https://crates.io/
[`match`]: ch06-02-match.html
[`parse` у строк]: ../std/primitive.str.html#method.parse