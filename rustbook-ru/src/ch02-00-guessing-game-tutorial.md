...
Теперь, когда у нас есть внешняя зависимость, Cargo выбирает последние версии всех крейтов из *реестра*, который является копией данных из [Crates.io](ch06-00-enums.html) . Crates.io - то место, где люди в экосистеме Rust размещают проекты с открытым исходным кодом для других.
...
[`parse` у строк ]: ch06-00-enums.html