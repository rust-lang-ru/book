...
Данная функция `new` создает новую пустую строку. Вы можете найти функцию `new` у многих типов, потому что это распространенное имя для функции, которая создает какое-то новое значение.
