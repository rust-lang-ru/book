...
По умолчанию Rust имеет несколько элементов, заданных в стандартной библиотеке, которые он включает в область видимости каждой программы. Этот набор называется *прелюдией (prelude)*, и [в документации по стандартной библиотеке](../std/prelude/index.html) можно увидеть все входящее в её состав элементы.
