...
Все исполнения сборщика Ржавчины поддерживают любое издание, которое предшествовало выпуску текущего, и они могут линковать дополнения любой поддерживаемой издания. Изменения изданий действуют только на способ начального разбора сборщиком исходной рукописи. Поэтому, если вы используете издание 2015, а одно из ваших дополнений использует издание 2018, ваш ящик будет собрано и сможет пользоваться этим дополнением. Обратный случай, когда ваш ящик использует издание Ржавчины 2018, а дополнение использует издание Ржавчины 2015, работает таким же образом.
