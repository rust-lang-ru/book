...
Свойства функции также могут быть образцами данных. Рукопись в приложении 18-6 объявляет функцию с именем `foo`, которая принимает одно свойство с именем `x` вида `i32`, к настоящему времени это должно выглядеть знакомым.
