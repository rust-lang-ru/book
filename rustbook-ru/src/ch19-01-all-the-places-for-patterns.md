...
`x` это часть образца! Как и в случае с `let`, мы можем сопоставить составной ряд в переменных функции с образцом. Приложение 18-7 разделяет значения в составном ряде при его передачи в функцию.
...
<span class="caption">Приложение 18-7: Функция с свойствами, которая разрушает составной ряд</span>
