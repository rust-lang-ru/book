...
- [Общие виды, сущности (свойства) и время жизни](ch10-00-generics.md)
...
- [Возможности предметно-направленного программирования Ржавчина](ch17-00-oop.md)
    ...
    - [Использование сущность-предметов, допускающих значения разных видов](ch17-02-trait-objects.md)
