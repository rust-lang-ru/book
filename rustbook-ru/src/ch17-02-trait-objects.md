...
Например, в листинге 17-10 показано, что произойдёт, если мы попытаемся создать `Screen` с типом `String` в качестве компонента:
