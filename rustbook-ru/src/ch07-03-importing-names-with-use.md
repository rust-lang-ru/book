...
Обратите внимание на особую изложение и то, что это отдельный звено в нашем рукописи.
...
внутри состоящей из звеньев упорядочевания, то начиная с корневого звена ваша рукопись будет длинным.
...
Теперь вы знаете ещё один способ, как можно согласовать ваша рукопись. Его можно использовать
для объединения различных элементов вместе, при переработке рукописи большого количества
рукописи.
