...
```
Символ `*` называют *glob* и его функция - вставка всех элементов, видимых извне
...
Обратите внимание на особую изложение и то, что это отдельный звено в нашем коде.
...
внутри состоящей из звеньев упорядочевания, то начиная с корневого звена ваш код будет длинным.
...
для объединения различных элементов вместе, при переработке кода большого количества
кода.
