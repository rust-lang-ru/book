...
Чтобы не указывать имя звена, можно использовать постоянную вставку функции в область видимости:
...
только необходимые элементы перечисления при вставке:
...
Состоящая из звеньев устройство нашего дела теперь имеет вид:
...
Или мы можем использовать `super` для того чтобы переместиться по состоящей из звеньев упорядочивания
...
Эти две возможности выглядят одинаковыми в этом примере. Если находитесь глубоко внутри состоящей из звеньев упорядочивания, то начиная с корневого звена ваша рукопись будет длинной.
