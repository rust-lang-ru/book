...
которые находятся в разделе `of`. Их можно вызывать просто указывая приставка имени этого
раздела `of::`.

В область видимости попадают только элементы раздела. Подчиненные разделе не включаются.
