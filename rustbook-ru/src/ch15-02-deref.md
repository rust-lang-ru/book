...
<span class="caption">Листинг 15-8: Определение типа <code>MyBox&lt;T data-md-type="raw_html"&gt;</code></span>
...
<span class="caption">Листинг 15-10: Реализация <code>Deref</code> для типа <code>MyBox&lt;T data-md-type="raw_html"&gt;</code></span>
...
<span class="caption">Листинг 15-12: Вызов <code>hello</code> со ссылкой на значение <code>MyBox&lt;String data-md-type="raw_html"&gt;</code>, которое работает из-за разыменованного приведения</span>
