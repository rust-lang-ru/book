...
Как обсуждалось в разделе [“Выполнение особенности для вида”]<!--  --> Главы 10, для выполнения особенности нужно предоставить выполнения требуемых способов особенности. Сущность `Deref`, предоставляемый встроенной библиотекой требует от нас выполнения одного способа с именем `deref`, который заимствует `self` и возвращает ссылку на внутренние данные. Приложение 15-10 содержит выполнение `Deref` добавленную к определению `MyBox`:
