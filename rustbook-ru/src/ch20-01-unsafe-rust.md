...
С помощью раздела `unsafe` мы сообщаем Ржавчине, что прочитали пособие к способы (функции), поняли, как правильно её использовать, и убедились, что выполняем договор способы (функции).

Тела небезопасных функций являются в действительности `unsafe` разделами, поэтому для выполнения других небезопасных действий внутри небезопасной способы (функции) не нужно добавлять ещё один `unsafe` раздел.
