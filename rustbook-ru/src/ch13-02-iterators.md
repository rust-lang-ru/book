...
Функция `shoes_in_size` принимает в качестве свойств вектор с образцами обуви и искомый нами размер обуви, а возвращает вектор, содержащий  обувь указанного размера с указанием наименования.
...
Проверка показывает, что когда мы вызываем `shoes_in_my_size`, мы возвращаем стопки с обувью `Shoe`  , размер которых мы запрашивали в свойстве функции `shoes_in_my_size`.
