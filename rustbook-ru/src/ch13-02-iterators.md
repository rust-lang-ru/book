...
В коде 13-20 определяется структура `Counter` и ассоциированная функция `new`,
создающая экземпляр структуры `Counter`:
...
<span class="caption">Код 13-22: Тестирование реализации метода `next`</span>
