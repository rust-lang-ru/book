...
В языках, стандартные библиотеки которых не предоставляют итераторы, вы, скорее всего, напишите эту же функциональность так - создав переменную со значением 0, в цикле будете использовать её для получения элемента вектора по индексу, увеличивая её значение, пока оно не достигнет числа равного количеству элементов в векторе.
