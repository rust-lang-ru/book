...
Это файл в формате [*TOML*](https://github.com/toml-lang/toml)<!--  --> (*Tom’s Obvious, Minimal Language*), который является форматом настроек Cargo.
...
- cargo сохраняет результаты сборки не в папку с исходным кодом, а в отдельный каталог *target/debug*.
...
### Сборка финальной исполнения (Release)
