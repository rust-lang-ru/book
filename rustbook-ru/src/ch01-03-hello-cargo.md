...
<span class="caption">Листинг 1-2: Содержимое файла <em>Cargo.toml</em> сгенерированное командой <code>cargo new</code></span>. Это файл в формате [*TOML*](https://github.com/toml-lang/toml)<comment> (<em data-md-type="emphasis">Tom’s Obvious, Minimal Language</em>), который является форматом конфигураций Cargo.</comment>
...
### Сброка финальной версии (Release)
