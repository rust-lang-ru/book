...
стороне образец `ThreadPool`, как показано в рукописи 201-16. `Job` является видом
...
рукопись собираются (хотя и c предупреждениями).
...
<<<<<<< HEAD
Этот рукопись 20-17 пока не будет собираться:
=======
...
и одного получателя, мы не можем просто раздваивать получающую часть потока для
решения сбоев.
...
<span class="caption">рукопись 20-18: разделение получающую часть потока между образцами
...
<<<<<<< HEAD
К сожалению, мы получим ошибку при сборки этого рукописи
=======
К сожалению, мы получим ошибку при сборки этой рукописи
>>>>>>> 8026f7cc37a623b7a0968ae296cbb5f4118ea196
