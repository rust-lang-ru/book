...
Есть и другие различия между способами (функциями) и замыканиями. Замыкания обычно не требуют определения видов данных в входных свойств или возвращаемого значения, как это делается в способ (функция)х `fn`. Изложения видов данных требуются для способов (функций), потому что виды данных находятся за пределами самой способы (функции), предоставляемого пользователям. Жёсткое определение видов данных необходимо для того, чтобы все вида данных были согласованы в том, какие виды данных использует и возвращает способ (функция). А вот замыкания, напротив, для них не требуется строго указывать виды данных: так как они могут храниться в переменных и использоваться не имея имени, при этом незримо для пользователей нашей библиотеки.
