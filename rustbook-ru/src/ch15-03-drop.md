...
<span class="caption">Приложение 15-14: Устройства <code>CustomSmartPointer</code>, выполняющее сущность <code>Drop</code>, куда мы поместим нашу рукопись очистки</span>
