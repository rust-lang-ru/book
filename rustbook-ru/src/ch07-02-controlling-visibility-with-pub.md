...
Для того, чтобы сделать что-либо доступным извне, необходимо добавить ключевое слово `pub` в начало объявления элемента рукописи. Для исправления ошибки, мы добавим
