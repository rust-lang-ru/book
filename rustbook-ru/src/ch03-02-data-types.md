...
Эта приложение создаёт составной ряд `x`, а затем обращается к каждой переменной составного ряда, используя соответствующие порядковые указатели. Как и в большинстве языков программирования, первый порядковый указатель в составном ряде равен 0.
