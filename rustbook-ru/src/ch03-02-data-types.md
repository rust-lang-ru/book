...
Для записи типа массива используются квадратные скбоки, внутри которых указывается тип каждого из элементов и через точку с запятой идёт количество элементов массива, как тут:
