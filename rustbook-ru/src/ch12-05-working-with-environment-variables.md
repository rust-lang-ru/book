...
### Написание ошибочного проверки для способы (функции) `search` с учётом заглавных или строчных букв
...
<span class="caption">Приложение 12-20: Добавление нового не проходящего проверки для способы (функции) поиска нечувствительной к  заглавным или строчным буквам, которую мы собираемся добавить</span>
...
<span class="caption">Приложение 12-21: Определение способы (функции) <code>search_case_insensitive</code> с уменьшением регистра строки запроса и строки содержимого перед их сравнением</span>
