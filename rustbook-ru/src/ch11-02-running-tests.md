...
### Отображение итогов работы способы (функции)
...
<span class="caption">Приложение 11-10: Проверка способы (функции), которая использует макрос <code>println!</code></span>
...
Для отображения, как запустить объединение проверок, мы создадим объединение проверок для способы (функции) `add_two` function, как показано в Приложении 11-11, и постараемся выбрать какие из них запускать.
