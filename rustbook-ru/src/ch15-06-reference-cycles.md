...
Далее мы будем использовать наше определение вида данных и создадим один образец данных `Node` с именем `leaf` со значением 3 и без дочерних элементов, а другой образец с именем `branch` со значением 5 и `leaf` в качестве одного из его дочерних элементов, как показано в приложении 15-27:
